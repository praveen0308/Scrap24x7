...
class ManagePickupRequestAdapter(private val mListener: ManagePickupRequestInterface) :

    RecyclerView.Adapter<ManagePickupRequestAdapter.ManagePickupRequestViewHolder>() {
    ...
    interface ManagePickupRequestInterface {
        ...
        fun onItemClick(request: PickupRequest)
    }
